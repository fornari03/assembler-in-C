...
SOURCES_MONTADOR = $(SRC_DIR)/montador.cpp $(SRC_DIR)/pre_process.cpp $(SRC_DIR)/diretivas.cpp $(SRC_DIR)/files_handler.cpp $(SRC_DIR)/utils.cpp $(SRC_DIR)/errors_handler.cpp
